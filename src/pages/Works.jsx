...
const CATEGORIES = [
  { id: "all", label: "All" },
  {
    id: "production",
    label: "Production",
    keywords: ["production", "composition", "sound design"],
  },
  ...
  { id: "mastering", label: "Mastering", keywords: ["mastering"] },
  {
    id: "immersive",
    label: "Immersive",
    keywords: ["immersive", "dolby", "spatial"],
  },
  {
    id: "sound-for-picture",
    label: "Sound for Picture",
    keywords: ["sound for picture", "scoring", "film"],
  },
              ...
              <div className="md:w-7/12 p-8 md:p-10 flex flex-col overflow-y-auto">
                ...
                <div className="space-y-8 flex-1">
                  <div className="flex flex-wrap gap-2">
                    {selectedWork.tags?.map((tag) => (
                      <span
                        key={tag}
                        className="text-[10px] uppercase tracking-wider border border-black/10 dark:border-white/10 px-2 py-1 rounded-full opacity-60"
                      >
                        {tag}
                      </span>
                    ))}
                ...
                <div className="mt-8 pt-6 border-t border-black/5 dark:border-white/5 flex justify-between items-center text-[10px] uppercase tracking-widest">
                  <span className="opacity-40">
                    PLATFORM: {selectedWork.type || "N/A"}
                  </span>
                  <a
